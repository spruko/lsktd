...
<html>
    <head>
        ...
        <title>@if (trim($__env->yieldContent('template_title')))@yield('template_title') | @endif @if (trim($__env->yieldContent('title')))@yield('title')@endif</title>
        <link rel="icon" type="image" href="{{ asset('installer/img/favicon/favicon.ico') }}"/>
    ...
    <body>
        <div class="master">
            <div class="box">
                ...
                <div class="copyright"> Copyright © {{ now()->format('Y') }} <a href="javascript:void(0);">TeamDesk</a>. Developed by <a href="javascript:void(0);"> Spruko Technologies Pvt.Ltd. </a> All rights reserved </div>
            </div>
