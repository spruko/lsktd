...
@section('container')
    ...
    <div class="">
        ...
        <p class="link"><span id="clipurl" class="clipurl">{{ url('/') }}</span>
        ...
        @if ($message = Session::get('success'))
            ...
            <p class="paragraph  text-bold"><span class="url-link">Password:-</span> <span id="clipurl2"
                    class="clipurl">{{ Session::get('password') }}</span>
